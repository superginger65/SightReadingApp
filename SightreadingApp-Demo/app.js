...
(function () {
  ...
  async function captureResultImage() {
    ...
    const modeStr = currentMode === "practice" ? "Practice" : "Challenge";
    const headerText = "Demo " + modeStr + "  |  " + meter + "  |  " + bpm + " BPM";
    ctx.fillStyle = "#333";
  ...
  async function startPlayback() {
    ...
    metronomeGainNode.gain.value = 1;
    metronomeGainNode.connect(playbackMasterGain);
